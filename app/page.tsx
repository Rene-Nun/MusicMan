    ...
    <>
      ...
      <section className="relative border-b border-neutral-200 bg-white lg:overflow-hidden">
        <div className="relative lg:h-[640px]">
          ...
          <div className="relative z-20 mx-auto max-w-xl bg-white px-6 py-12 text-center sm:px-10 sm:py-16 lg:absolute lg:inset-x-0 lg:bottom-12 lg:mx-auto lg:max-w-2xl lg:bg-transparent lg:px-0 lg:py-0 lg:text-center">
            <h1 className="font-display text-4xl font-semibold leading-tight text-neutral-900 sm:text-5xl lg:text-white lg:[filter:drop-shadow(0_2px_10px_rgba(0,0,0,0.65))]">
